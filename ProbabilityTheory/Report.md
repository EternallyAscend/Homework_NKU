...
我们首先可以按照上述的方法计算一下两百人能够获得特赦的概率，约为$0.31434656951817578470$，以下近似为$31.43\%$，对于两个100人的组，每个组成功的概率近似为$31.18\%$

两组全部完成特赦，则特赦的概率为$31.18\%\times31.18\%\approx9.72\%$，这种规则下明显降低了特赦的概率。

两组结果一致特赦，则特赦的概率为$31.18\%\times31.18\%+68.82\%\times68.82\%\approx57.08\%$

三百人能够获得特赦的概率约为$0.31185004167770866868$，以下近似为$31.19\%$

三组结果一致特赦，则特赦的概率为$31.18\%\times31.18\%\times31.18\%+68.82\%\times68.82\%\times68.82\%\approx57.08\%$
...
// 当替换为101至200后 输出为:
// 0.68565343048182421530
// 0.31434656951817578470

// 0.68814995832229133132
// 0.31185004167770866868
```
