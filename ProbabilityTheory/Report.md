...
以上的分析思路可以应用于抽屉的总数为$2n$，允许开启$n$个抽屉，或者抽屉的总数为$2n+1$，允许开启$n$或$n+1$个抽屉的情况。$(n\gt0)$
...
总数量从100变化到$n$趋于无穷大的情况时概率的变化并不大，因此在此策略下可以探究通过分组并改变规则来改变对应的概率，100个囚犯进行一次活动和100个囚犯分为两组分别活动的对比。
